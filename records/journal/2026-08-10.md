...
* **LeetCode Exercises Solved & Documented:**
  * [Two Sum (#1)](../../practice/LeetCode/0001-two-sum.md) — Walkthrough and hash map optimizations.
  * [Palindrome Number (#9)](../../practice/LeetCode/0009-palindrome-number.md) — Walkthrough and mathematical approaches.
  * [Roman to Integer (#13)](../../practice/LeetCode/0013-roman-to-integer.md) — Walkthrough and value subtraction rules.
  * [Longest Common Prefix (#14)](../../practice/LeetCode/0014-longest-common-prefix.md) — Standard and character comparison approaches.
  * [Merge Two Sorted Lists (#21)](../../practice/LeetCode/0021-merge-two-sorted-lists.md) — Linked list pointer management.
  * [Remove Duplicates from Sorted Array (#26)](../../practice/LeetCode/0026-remove-duplicates-from-sorted-array.md) — In-place array modification.
  * [Remove Element (#27)](../../practice/LeetCode/0027-remove-element.md) — In-place array modification using two-pointers.
  * [Find the Index of the First Occurrence in a String (#28)](../../practice/LeetCode/0028-find-the-index-of-the-first-occurrence-in-a-string.md) — Substring matching.
  * [Search Insert Position (#35)](../../practice/LeetCode/0035-search-insert-position.md) — Binary search implementations.
...
* **Repository Architecture & Layout:**
  * Restructured the repository to place the codebase files inside the `src/` directory (conforming to [ADR 0004](https://github.com/kiskaadee/bitetrack-api/blob/main/docs/adr/0004-project-structure.md)).
...
* **Agent Path Auto-Discovery:**
  ...
  * Updated `AGENTS.md` in the `backend-residency` repository to guide agents to read this file instead of searching the system.
* **Link Portability:**
