...
### Homelab Appliance Cutover & Documentation Audit
...
## Next Objectives
- Once the server running generation has been verified over an extended period, formally deprecate and purge the legacy `hosts/server/` folder and server configurations from the `Config` repository (Phase 5).
